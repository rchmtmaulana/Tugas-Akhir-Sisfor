...
<template>
    ...
    <div class="slug flex w-full text-white" style="height: 120px; margin-top: 130px; width: 100%;">
        ...
        <p style="margin: 0px 0px 0px 10px; padding-top: 30px; font-size: 20px; font-family: Times New Roman Thin;">Profil > {{ sejarahData.slug }}</p>
    </div>
    <div  Style="background-color: #d3d3dd">
        <section class="flex justify-center relative" >
            <div class="content offside max-w-screen-xl w-full bg-white border rounded-xl overflow-hidden" style=" margin-top: -30px;">
                <div class="pb-5">
                <h1 class="font-bold pt-5 text-center" style="font-family: Times New Roman Thin; font-size: 40px">Sejarah</h1>
                </div>
                <img :src="getImageUrl(sejarahData.gambar)" :alt="`sejarah ${sejarahData.id}`" class="w-full object-cover rounded-md" style="width: 500px;">
